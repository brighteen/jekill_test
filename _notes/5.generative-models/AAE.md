...
![AAE figure 1.png]({{ site.baseurl }}/assets/5_aae-figure-1.png){: .img-normal .img-normal }
Figure 1: AAE 아키텍처  
...
![AAE figure 2.png]({{ site.baseurl }}/assets/5_aae-figure-2.png){: .img-normal .img-normal }
...
![AAE figure 3.png]({{ site.baseurl }}/assets/5_aae-figure-3.png){: .img-normal .img-normal }
...
![AAE figure 4.png]({{ site.baseurl }}/assets/5_aae-figure-4.png){: .img-normal .img-normal }
...
![AAE figure 5.png]({{ site.baseurl }}/assets/5_aae-figure-5.png){: .img-normal .img-normal }
...
![AAE table 1.png]({{ site.baseurl }}/assets/5_aae-table-1.png){: .img-normal .img-normal }
...
![AAE figure 6.png]({{ site.baseurl }}/assets/5_aae-figure-6.png){: .img-normal .img-normal }
...
![AAE figure 7.png]({{ site.baseurl }}/assets/5_aae-figure-7.png){: .img-normal .img-normal }
...
![AAE figure 8.png]({{ site.baseurl }}/assets/5_aae-figure-8.png){: .img-normal .img-normal }
...
![AAE table 2.png]({{ site.baseurl }}/assets/5_aae-table-2.png){: .img-normal .img-normal }
...
![AAE figure 9.png]({{ site.baseurl }}/assets/5_aae-figure-9.png){: .img-normal .img-normal }
...
![AAE table 3.png]({{ site.baseurl }}/assets/5_aae-table-3.png){: .img-normal .img-normal }
...
![AAE figure 10.png]({{ site.baseurl }}/assets/5_aae-figure-10.png){: .img-normal .img-normal }
...
![AAE figure 11 a,b.png]({{ site.baseurl }}/assets/5_aae-figure-11-a-b.png){: .img-normal .img-normal }
Figure 11(a,b)는 각각 1,000, 100개의 레이블을 사용(준지도)하여 mnist데이터셋(m=10)을 2차원으로 축소함. 분류 오차는 고차원마늠 좋지 않으며, 각 클러스터의 분포가 완벽한 가우시안은 아님.  
![AAE figure c,d.png]({{ site.baseurl }}/assets/5_aae-figure-c-d.png){: .img-normal .img-normal }
